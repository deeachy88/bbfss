    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Establish_Type', models.CharField(max_length=200)),
                ('Establishment_Size', models.CharField(max_length=200)),
                ('Meat_Type', models.CharField(max_length=200)),
                ('Clearance_Type', models.CharField(max_length=10)),
                ('Any_Proceedings', models.CharField(max_length=10)),
                ...
                ('Conformity', models.CharField(max_length=10)),
