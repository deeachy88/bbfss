# Generated by Django 3.1.5 on 2021-04-05 12:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Manpower_Labour', models.CharField(blank=True, max_length=20, null=True)),
                ('Manpower_Skilled', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Crop_Category_Id', models.IntegerField(blank=True, default=None, null=True)),
                ('Crop_Id', models.IntegerField(blank=True, default=None, null=True)),
                ('Crop_Scientific_Name', models.CharField(blank=True, max_length=100, null=True)),
                ('Variety_Id', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Certificate_Date', models.DateField(blank=True, default=None, null=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('Application_No', models.CharField(max_length=30, primary_key=True, serialize=False)),
                ('Crop_Id', models.IntegerField(blank=True, default=None, null=True)),
                ('Variety_Id', models.IntegerField(blank=True, default=None, null=True)),
