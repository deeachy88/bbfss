...
urlpatterns = [
    ...
    path('edit_nc_details', views.edit_nc_details, name='edit_nc_details'),
    ...
    path('edit_oc_nc_details', views.edit_oc_nc_details, name='edit_oc_nc_details'),
    ...
    path('edit_fpc_nc_details', views.edit_fpc_nc_details, name='edit_fpc_nc_details'),
