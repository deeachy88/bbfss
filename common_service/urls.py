...
# Establishment Inspection and Monitoring
    ...
    path('submit_establishment_inspection_form', views.submit_establishment_inspection_form,
         name='submit_establishment_inspection_form'),
    ...
    path('update_inspection_establishment_application', views.update_inspection_establishment_application,
         name='update_inspection_establishment_application'),
    path('submit_draft_inspection_details', views.submit_draft_inspection_details,
         name='submit_draft_inspection_details'),
    path('load_establishment_nc_details', views.load_establishment_nc_details,
         name='load_establishment_nc_details'),
    path('load_establishment_seized_details', views.load_establishment_seized_details,
         name='load_establishment_seized_details'),
    path('load_establishment_sample_details', views.load_establishment_sample_details,
         name='load_establishment_sample_details'),
...
# Commodity Inspection and Monitoring
    ...
    path('update_inspection_commodity_application', views.update_inspection_commodity_application,
         name='update_inspection_commodity_application'),
